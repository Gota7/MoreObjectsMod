#ifndef Goomba_COLORED_2_INCLUDED
#define Goomba_COLORED_2_INCLUDED

#include "SM64DS_2.h"
	
struct Goomba2 : public CapEnemy
{
	enum SizeType
	{
		SMALL = 0,
	...
	char silverStarID;
	char charBehav; //0 = speed + lightning, 1 = fire, 2 = instakill
	//original: 0 = jump, 1 = jump 'n' spin, 2 = do double damage
	...
	bool UpdateIfDying();
	void RenderRegurgGoomba2Helpless(Player* player);
	...
	static SpawnInfo<Goomba2> spawnDataNormal, spawnDataSmall, spawnDataBig;
