...
#define OBJ_TO_ACTOR_ID_TABLE ((volatile uint16_t*)0x02004b00) //0x500 big for 0x280 entries.
#define ACTOR_SPAWN_TABLE     ((volatile unsigned*)0x02006590) //0xA70 big for 0x29C entries.
...
extern "C"
{
	...
	void RunKuppaScript(char* scriptAddress);
	void EndKuppaScript();
